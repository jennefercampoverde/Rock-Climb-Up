...
<table class="tablesFormatForms">
  ...
  <div id="unEnrollClassContainer" class="dashboardContainers">
    ...
    <form id="classForm" action="POST">
      ...
      <br> <input type="Submit" name="enrollUserClass" value="Un-enroll">
    </form>
  </div>
</td>
<td>
    ...
    <form id="eventForm" action="POST">
      ...
      <br> <input type="Submit" name="enrollUserEvent" value="Un-enroll">
    </form>
  </div>
</td>
</tr>
...
if(isset($_POST['enrollUserEvent'])){
$AddEvent="UPDATE classes SET Difficulty = "Intermediate" WHERE ClassID = '$classIDProvided'";

}
else if(isset($_POST['enrollUserClass'])){
  $AddClass="UPDATE classes SET Difficulty = "Intermediate" WHERE ClassID = '$classIDProvided'";
